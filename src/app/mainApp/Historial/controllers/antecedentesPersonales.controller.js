...
(function(){
    ...
    angular
        ...
        .controller('antecedentesPersonalesController', antecedentesPersonalesController);

    function antecedentesPersonalesController($timeout, $q, $log) {
        var vm = this;
        ...
        vm.Tipoenfermedades = [{
            id: '1',
            nombre: 'Enfermedades Cardiacas',
        }, {
            id: '2',
            nombre: 'Enfermedades Internas',
        }, {
            id: '3',
            nombre: 'Enfermedades Neuronales',
        }, {
            id: '4',
            nombre: 'Enfermedades Inmunologicas',
        },
            {
                id: '5',
                nombre: 'Enfermedades Hepaticas',
            }
        ];
